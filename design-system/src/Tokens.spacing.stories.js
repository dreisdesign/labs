...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: "Spacing tokens for layouts and components in the Labs Design System. Click any token to copy the CSS custom property name.",
      },
    },
  },
};
...
export const Spacing = {
  ...
  parameters: {
    docs: {
      description: {
        story: "All spacing tokens with live preview. Click any token to copy the CSS custom property name."
      }
    }
  }
};
