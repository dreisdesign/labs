...
export default {
  ...
  argTypes: {
    ...
    icon: {
      control: { type: "select" },
      name: "Left Icon Name",
      description: "Icon name for left side (Material Icons)",
      options: [
        "",
        "add_comment",
        "bedtime",
    ...
    iconRightName: {
      ...
      description: "Icon name for right side (Material Icons)",
      options: [
        "",
        "add_comment",
        "bedtime",
...
// Comprehensive button variants showcase
...
AllVariants.parameters = {
  docs: {
    description: {
      story: "Complete overview of all button variants, icon combinations, and usage guidelines. This showcase demonstrates the full capabilities of the Labs button component.",
    },
  },
};

AllVariants.storyName = "All Variants Showcase";
