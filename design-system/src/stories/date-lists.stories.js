...
export const ActivityTimeline = {
  render: () => {
    // ...existing code from DateListTemplate...
    const now = new Date();
    ...
    return `
      <style>
        .date-list-demo { max-width: 800px; margin: 0 auto; font-family: var(--font-family-primary); }
        .date-section { margin-bottom: 2rem; }
        .date-header { margin-top: 1rem; margin-bottom: 0.75rem; }
        .time-entries { display: flex; flex-direction: column; gap: var(--space-sm); align-items: center; }
        .time-entry { display: flex; align-items: center; justify-content: center; padding: 0.75rem; background: var(--color-surface); border-radius: 0.7rem; width: 90%; max-width: 95%; box-sizing: border-box; cursor: pointer; transition: transform 0.3s ease-out, opacity 0.15s ease-out; border: 1px solid var(--color-outline-variant); text-align: center; color: var(--color-on-surface); text-decoration: none; }
        .time-entry:hover { transform: scale(1.02); background: var(--color-surface-container-high); }
        .time-entry:active { transform: scale(0.95); transition-duration: 0.05s; }
        .entry-content { display: flex; flex-direction: column; align-items: center; gap: var(--space-xs); }
        .entry-text { font-size: var(--font-size-body); font-weight: 500; margin-bottom: var(--space-xs); }
        .stats-header { text-align: center; margin-bottom: 2rem; padding: var(--space-lg); background: var(--color-surface-container); border-radius: var(--border-radius-lg); border: 1px solid var(--color-outline-variant); }
        .stats-title { font-size: var(--font-size-h3); font-weight: 600; color: var(--color-on-surface); margin-bottom: var(--space-sm); }
        .stats-count { font-size: var(--font-size-body); color: var(--color-on-surface-variant); }
        .empty-state { text-align: center; color: var(--color-on-surface-variant); font-style: italic; padding: var(--space-xl); }
      </style>
...
export const TasksByDate = {
  render: () => {
    // ...existing code from TaskListByDateTemplate...
    ...
    return `
      <style>
        .task-list-demo { max-width: 700px; margin: 0 auto; font-family: var(--font-family-primary); }
        .date-section { margin-bottom: 2rem; }
        .date-header { margin-bottom: 1rem; }
        .task-list { display: flex; flex-direction: column; gap: var(--space-sm); }
        .section-stats { text-align: center; margin-bottom: 1rem; font-size: var(--font-size-body-sm); color: var(--color-on-surface-variant); }
      </style>
