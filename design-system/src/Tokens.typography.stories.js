...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: "Typography tokens for the Labs Design System. Click any token to copy the CSS custom property name.",
      },
    },
  },
};
...
export const Typography = {
  ...
  parameters: {
    docs: {
      description: {
        story: "All typography tokens with live preview. Click any token to copy the CSS custom property name."
      }
    }
  }
};
