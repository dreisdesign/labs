import"./labs-icon-BgHZyyah.js";import{i}from"./icons-list-DlYdXJEz.js";const m={title:"Icons/Default",argTypes:{name:{control:{type:"select"},options:i,defaultValue:"cancel"},size:{control:{type:"number",min:16,max:128,step:4},description:"Icon size in pixels"},color:{control:{type:"color",presetColors:[]},description:"Icon color"}}},o=e=>{const a=e.size||48,s=e.color||"currentColor",n=document.createElement("div");n.style.cssText=`
    display: flex;
