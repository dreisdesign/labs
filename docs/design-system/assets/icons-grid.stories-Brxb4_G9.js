...
const c = [
  ...
  o = { title: "Icons/Preview", parameters: { docs: { page: null } } },
  n = () => {
    ...
    return (
      ...
      c.forEach((r) => {
        ...
        const a = document.createElement("labs-icon");
        a.setAttribute("name", r),
          a.setAttribute("style", "width:32px; height:32px;");
...
const s = ["Grid"];
export { n as Grid, s as __namedExportsOrder, o as default };
