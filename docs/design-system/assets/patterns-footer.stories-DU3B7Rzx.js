import"./labs-button-DO-8kIze.js";import"./labs-footer-BN2MhWoz.js";/* empty css                *//* empty css                   */import"./labs-icon-CWhhJZRA.js";const c={title:"Patterns",parameters:{docs:{description:{component:"Common UI patterns and page layouts using the Labs Design System components."}}}},t=()=>{const e=document.createElement("div");e.style.cssText=`
    display: flex;
  ...
  `;const o=e.querySelector("labs-footer");return o&&o.addEventListener("add-click",()=>{alert("Add button clicked from basic footer!")}),e};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  ...
  return container;
}`,...t.parameters?.docs?.source}}};const l=["Footer"];export{t as Footer,l as __namedExportsOrder,c as default};
