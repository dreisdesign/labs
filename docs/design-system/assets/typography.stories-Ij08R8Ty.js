import"./iframe-CmtmUGKZ.js";import"./preload-helper-PPVm8Dsz.js";const x={title:"0. Tokens/Typography",parameters:{viewMode:"docs"}},o={name:"Typography",render(){const t=getComputedStyle(document.documentElement).getPropertyValue("--font-size-metric-display"),l=getComputedStyle(document.documentElement).getPropertyValue("--font-size-metric-label"),c=getComputedStyle(document.documentElement).getPropertyValue("--font-weight-metric"),e=getComputedStyle(document.documentElement).getPropertyValue("--line-height-metric"),d=getComputedStyle(document.documentElement).getPropertyValue("--font-size-h1"),n=getComputedStyle(document.documentElement).getPropertyValue("--font-weight-heading");let r=getComputedStyle(document.documentElement).getPropertyValue("--line-height-heading").trim();r||(r="1.2");const a=getComputedStyle(document.documentElement).getPropertyValue("--font-size-h2"),i=getComputedStyle(document.documentElement).getPropertyValue("--font-size-h3");return`
