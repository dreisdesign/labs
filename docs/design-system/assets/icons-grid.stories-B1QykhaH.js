  ...
  n = () => {
    ...
    return (
      ...
      c.forEach((r) => {
        ...
        (a.innerHTML = `<a href="./?path=/story/icons-default--default&args=name:${r}" target="_parent">View in story</a>`),
          t.appendChild(i),
          t.appendChild(l),
          t.appendChild(a),
          e.appendChild(t);
...
const s = ["GridPreview"];
export { n as GridPreview, s as __namedExportsOrder, o as default };
