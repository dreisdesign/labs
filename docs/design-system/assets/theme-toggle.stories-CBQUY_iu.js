import"./labs-button-Bx1giWRG.js";import"./labs-icon-C5jqRpMf.js";const i={title:"Components/Theme/ThemeToggleButton",parameters:{docs:{description:{component:"A theme toggle button using <labs-button> and <labs-icon> that manages only its own UI state."}}}},t=()=>{const r=document.createElement("div");r.innerHTML=`
