import"./labs-task-item-CPOLYhYt.js";import"./labs-checkbox-4QdUhj6-.js";import"./labs-button-DHQuKs1y.js";import"./labs-icon-CZw9JeVg.js";import"./labs-input-overlay-HDbk_cjz.js";import"./labs-undo-button-hS4EhZGj.js";import"./labs-input-D7o3KkaA.js";import"./button-configs-DUKrH4Iw.js";const b={title:"Patterns/Task Interaction",parameters:{docs:{description:{component:"Complete task interaction patterns showing checkbox functionality, edit on hover, and task state management as used in Today List app."}}}},i=()=>(setTimeout(()=>{const o=document.querySelector("labs-input-overlay"),s=document.querySelector("labs-undo-button");document.addEventListener("labs-checkbox-change",t=>{console.log("Task changed:",t.detail)}),document.addEventListener("labs-task-edit",t=>{console.log("Edit task requested:",t.detail),o.open("Edit Task","Update task text...",t.detail.text,t.detail.taskId)}),document.addEventListener("labs-task-delete",t=>{console.log("Delete task requested:",t.detail),s.show(`"${t.detail.text}" deleted`,"delete",5e3),document.querySelectorAll("labs-task-item").forEach(e=>{e.getAttribute("task-id")===t.detail.taskId&&(e.style.opacity="0.5",e.style.pointerEvents="none")})}),document.addEventListener("labs-undo-action",t=>{console.log("Undo action triggered:",t.detail),t.detail.actionType==="delete"&&(document.querySelectorAll("labs-task-item").forEach(e=>{e.style.opacity="1",e.style.pointerEvents="auto"}),console.log("Task restored"))}),document.addEventListener("labs-undo-dismiss",t=>{console.log("Delete action confirmed (not undone):",t.detail)}),document.addEventListener("task-save",t=>{console.log("Task saved:",t.detail);const a=t.detail.index?`Updated task ${t.detail.index}: "${t.detail.text}"`:`Created new task: "${t.detail.text}"`;alert(a)})},100),`
    <style>
      .task-demo {
        max-width: 400px;
        margin: 0 auto;
  ...
  `),n=i.bind({});n.parameters={docs:{description:{story:"Complete task interaction pattern showing checkbox state management, hover-revealed edit buttons, and visual feedback for completed tasks. This demonstrates the default behavior where clicking tasks opens edit functionality instead of creating new tasks."}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`() => {
  ...
  \`;
}`,...n.parameters?.docs?.source}}};const v=["TaskItems"];export{n as TaskItems,v as __namedExportsOrder,b as default};
