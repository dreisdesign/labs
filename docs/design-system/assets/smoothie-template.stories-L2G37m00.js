import"./labs-footer-Cz6M6BBG.js";import"./iframe-jSMGooAK.js";import{i as h}from"./icons-list-BKmguoAm.js";import"./labs-overlay-AWkXp-xX.js";import"./labs-settings-card-DRomfs_T.js";import"./preload-helper-PPVm8Dsz.js";const k={title:"Templates/Smoothie Template",parameters:{docs:{description:{component:"A minimal template for pattern demos: footer, flavor switcher, and settings overlay."}}},argTypes:{settingsIcon:{name:"settingsIcon",control:{type:"select"},options:Object.keys(h)}}},i={render:c=>{const n=document.createElement("div");n.innerHTML=`
      <style>
