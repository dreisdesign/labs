import{x as r}from"./iframe-BEVxoZ3v.js";import{i as b}from"./icons-list-Dfk_UYgx.js";import"./preload-helper-D9Z9MdNV.js";const a={"On Surface":"var(--color-on-surface)","On Primary":"var(--color-on-primary)",Primary:"var(--color-primary)",Error:"var(--color-error)","On Error":"var(--color-on-error)","Settings Icon":"var(--settings-icon-color)"},d={title:"Patterns/Buttons/Icon Only",argTypes:{icon:{options:b,control:{type:"select"},description:"Icon name"},colorVariant:{options:Object.keys(a),control:{type:"select"},description:"Icon color variant"},ariaLabel:{control:"text",description:"Aria label for accessibility"},label:{control:"boolean",description:"Show label below the icon (for footer-like usage)"},animation:{control:"boolean",description:"Enable icon hover animation"}},parameters:{docs:{description:{component:"A canonical pattern for icon-only actions. Used for theme, delete, settings, close, etc. Supports animation and accessibility."}}}},o=({icon:e="settings",colorVariant:i="On Surface",ariaLabel:n="Settings",animation:l=!0,label:s=!1})=>{const c=`
