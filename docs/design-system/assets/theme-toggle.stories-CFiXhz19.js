import"./labs-button-TwfSpcbC.js";import"./labs-icon-BtJ2RHil.js";const i={title:"Components/Theme/ThemeToggleButton",parameters:{docs:{description:{component:"A theme toggle button using <labs-button> and <labs-icon> that manages only its own UI state."}}}},t=()=>{const r=document.createElement("div");r.innerHTML=`
