...
const a = {
    title: "Icons/Default",
    argTypes: {
      name: { control: { type: "select" }, options: c, defaultValue: "cancel" },
      size: {
  ...
  o = (e) => {
    const r = e.size || 32,
      s = e.color || "currentColor";
    return `<labs-icon name="${e.name}" style="width:${r}px;height:${r}px;color:${s};"></labs-icon>`;
  };
o.args = { name: "cancel", size: 32, color: "currentColor" };
const l = ["Default"];
o.parameters = {
  ...o.parameters,
  docs: {
