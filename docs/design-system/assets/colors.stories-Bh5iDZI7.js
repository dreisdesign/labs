import"./iframe-DVmFY04n.js";import"./preload-helper-PPVm8Dsz.js";function R(u={}){const c=u&&u.onlyFlavor?String(u.onlyFlavor):"",v={global:{"--palette-base-100":"Surface","--palette-base-500":"Outline","--palette-base-800":"Text","--palette-green-500":"Success","--palette-yellow-500":"Warning","--palette-red-500":"Error"},vanilla:{"--palette-vanilla-100":"Surface","--palette-vanilla-200":"Background","--palette-vanilla-300":"Primary Lighter","--palette-vanilla-500":"Primary","--palette-vanilla-800":"Primary Darker","--palette-vanilla-900":"Background Darkest"},blueberry:{"--palette-blueberry-100":"Surface","--palette-blueberry-200":"Background","--palette-blueberry-300":"Primary Lighter","--palette-blueberry-500":"Primary","--palette-blueberry-800":"Primary Darker","--palette-blueberry-900":"Background Darkest"},strawberry:{"--palette-strawberry-100":"Surface","--palette-strawberry-200":"Background","--palette-strawberry-300":"Primary Lighter","--palette-strawberry-500":"Primary","--palette-strawberry-800":"Primary Darker","--palette-strawberry-900":"Background Darkest"}},w=(s,g,i,e)=>{let o="";return v[s]&&v[s][i]&&(o=`<br><span style="font-weight:bold;font-size:13px;opacity:0.8;">${v[s][i]}</span>`),`
    ...
    `},_=s=>c&&c!==s?'style="display:none;"':"",b={global:{label:"Global",tokens:["--color-surface","--color-surface-alt","--color-success","--color-warning","--color-error"],palette:["--palette-base-100","--palette-base-500","--palette-base-800"],statusPalette:["--palette-green-500","--palette-yellow-500","--palette-red-500"]},blueberry:{semantic:["--color-primary","--color-primary-darker","--color-primary-lighter","--color-background-darkest"],neutrals:["--color-surface","--color-background"],palette:["--palette-blueberry-100","--palette-blueberry-200","--palette-blueberry-300","--palette-blueberry-500","--palette-blueberry-800","--palette-blueberry-900"],accents:[]},strawberry:{semantic:["--color-primary","--color-primary-darker","--color-primary-lighter","--color-background-darkest"],neutrals:["--color-surface","--color-background"],palette:["--palette-strawberry-100","--palette-strawberry-200","--palette-strawberry-300","--palette-strawberry-500","--palette-strawberry-800","--palette-strawberry-900"],accents:[]},vanilla:{semantic:["--color-primary","--color-primary-darker","--color-primary-lighter","--color-background-darkest"],neutrals:["--color-surface","--color-background"],palette:["--palette-vanilla-100","--palette-vanilla-200","--palette-vanilla-300","--palette-vanilla-500","--palette-vanilla-800","--palette-vanilla-900"],accents:[]}},O=s=>{const g=b[s];return Array.from(new Set([...g.semantic||[],...g.neutrals||[]]))},T=c?`flavor-${c} theme-light`:"flavor-global theme-light",I=c?`data-only-flavor="${c}"`:"";let P="";if(c&&b[c]){const s=c,g=O(s);P=`
  <details class="flavor-column flavor-${s}" ${_(s)} open style="margin-top:12px">
        ...
        <div class="polaroid-row polaroid-palette" style="margin-bottom:18px;">
          ${b[s].palette.map(i=>w(s,i.replace(/^--/,""),i)).join("")}
        </div>
        <div class="token-list-wrap">
          <table class="token-list">
            ...
            <tbody>
              ${g.map(i=>{let e="",o="";if(/--palette-(vanilla|blueberry|strawberry)-([0-9]+)/.test(i)){const r=i.match(/([0-9]+)$/)[1];["100","200","300"].includes(r)?(o="--color-on-primary-lighter",e="var(--color-on-primary-lighter, #000)"):(o="--color-on-primary-darker",e="var(--color-on-primary-darker, #fff)")}return`
                <tr>
                  <td><code>${i}</code></td>
                  <td><span class="swatch-thumb" data-var="${i}" style="background:var(${i});"><span class="swatch-thumb-text" data-var="${i}" style="color:${e}">Aa</span></span></td>
                  <td class="list-resolved" data-var="${i}">resolving...</td>
                  <td class="list-chain" data-var="${i}">–</td>
                  <td class="list-text-color" data-var="${i}">${o?`<code>${o}</code>`:"computing..."}</td>
  ...
  <div class="palette-heading">Core Palette</div>
        <div class="polaroid-row polaroid-palette" style="margin-bottom:18px;">
          ${b.global.palette.map(s=>w("global",s.replace(/^--/,""),s)).join("")}
        </div>
  <div class="palette-heading">Status Palette</div>
        <div class="polaroid-row polaroid-palette" style="margin-bottom:18px;">
          ${b.global.statusPalette.map(s=>w("global",s.replace(/^--/,""),s)).join("")}
        </div>
        <div class="token-list-wrap">
          <table class="token-list">
            <thead><tr><th>Semantic</th><th>Swatch</th><th>Resolved</th><th>Base</th><th>Text color</th><th>Contrast</th></tr></thead>
            <tbody>
              ${b.global.tokens.map(s=>`
                <tr>
                  <td><code>${s}</code></td>
  ...
  `;return setTimeout(()=>{document.querySelectorAll(".swatch-thumb, .swatch-thumb-text").forEach(t=>{t.addEventListener("click",function(d){const l=t.getAttribute("data-var");if(!l)return;let n=getComputedStyle(document.documentElement).getPropertyValue(l).trim();n||(n=l),navigator.clipboard.writeText(n),t.style.outline="2px solid #007aff",setTimeout(()=>{t.style.outline=""},600)})}),document.querySelectorAll(".list-resolved").forEach(t=>{const d=t.getAttribute("data-var");if(d){const l=getComputedStyle(document.documentElement).getPropertyValue(d).trim();t.textContent=l||"unset"}});const s=document.documentElement.getAttribute("data-flavor"),g=Array.from(document.documentElement.classList).find(t=>t.indexOf("flavor-")===0);let i=s||(g?g.replace("flavor-",""):"blueberry");if(!s&&!g)try{const d=new URL(window.location.href).searchParams.get("globals")||"",l=decodeURIComponent(d||"");try{if(l&&(l[0]==="{"||l.indexOf('"flavor"')!==-1)){const n=JSON.parse(l);n&&n.flavor&&(i=n.flavor)}}catch{}if(!i||i==="blueberry"){const n=l.match(/flavor:([^,&\}\"]+)/)||d.match(/flavor:([^,&\}\"]+)/)||d.match(/flavor%3A([^,&\}\"]+)/i);n&&n[1]&&(i=decodeURIComponent(n[1]))}}catch{}const e=(t,d)=>`--palette-${t}-${d}`,o=t=>({"--color-primary":e(t,"500"),"--color-primary-darker":e(t,"800"),"--color-primary-lighter":e(t,"300"),"--color-surface":e(t,"100"),"--color-background":e(t,"200")}),r={"--color-primary":"--color-on-primary","--color-primary-darker":"--color-on-primary-darker","--color-primary-lighter":"--color-on-primary-lighter","--color-surface":"--color-on-surface","--color-background":"--color-on-background"},a=o(i);try{window.__colors_last_resolutions=window.__colors_last_resolutions||[],window.__colors_last_resolutions.push({debug:"baseMapSnapshot",flavor:i,baseMap:a,ts:Date.now()})}catch{}document.querySelectorAll(".list-chain").forEach(t=>{const d=t.getAttribute("data-var");if(d){const l=a[d]||"–";t.innerHTML=l!=="–"?`<code>${l}</code>`:"–"}}),document.querySelectorAll(".list-text-color").forEach(t=>{const d=t.getAttribute("data-var");if(d){const l=r[d];l?t.innerHTML=`<code>${l}</code>`:t.textContent="computing..."}})},300),F}function G(){function u(e,o){try{if(o&&o.nodeType===1)return getComputedStyle(o).getPropertyValue(e).trim()}catch{}return getComputedStyle(document.documentElement).getPropertyValue(e).trim()}function c(e,o,r){o=o||[];var a=u(e,r);if(!a)return{chain:[e],value:"unset"};if(a=a.trim(),a.indexOf("var(")===0){var t=a.slice(4,-1).trim(),d=t.split(/,(.+)/).map(function(x){return x&&x.trim()}).filter(Boolean),l=d[0],n=d[1]||null;if(!l||o.indexOf(l)!==-1||l===e)return{chain:[e,l],value:n||a};var p=c(l,o.concat([e]),r);return{chain:[e].concat(p.chain),value:p.value}}return{chain:[e],value:a}}function v(e){if(!e)return null;e=e.trim();try{if(e.indexOf("rgb")===0){var o=e.replace(/[rgba()]/g,"").split(",").map(function(t){return parseFloat(t.trim())});return{r:o[0],g:o[1],b:o[2],a:o[3]||1}}if(e[0]==="#"){var r=e.slice(1);r.length===3&&(r=r.split("").map(function(t){return t+t}).join(""));var a=parseInt(r,16);return{r:a>>16&255,g:a>>8&255,b:a&255,a:1}}}catch{}return null}function w(e){var o=Math.round(e||0),r=(o<0?0:o>255?255:o).toString(16);return r.length===1?"0"+r:r}function _(e){try{var o=v(e);return o?"#"+w(o.r)+w(o.g)+w(o.b):null}catch{return null}}function b(e){try{if(!e||typeof e!="string")return e;var o=e.trim();if(o[0]!=="#")return e;var r=o.slice(1).toLowerCase();return r.length===3&&(r=r.split("").map(function(a){return a+a}).join("")),r.length===6&&/^[0-9a-f]{6}$/.test(r)?"#"+r:e}catch{return e}}function O(e){return e=e/255,e<=.03928?e/12.92:Math.pow((e+.055)/1.055,2.4)}function T(e){return .2126*O(e.r)+.7152*O(e.g)+.0722*O(e.b)}function I(e,o){var r=T(e),a=T(o),t=Math.max(r,a),d=Math.min(r,a);return(t+.05)/(d+.05)}const P={global:{tokens:["--color-surface","--color-surface-hover","--color-surface-alt","--color-success","--color-warning","--color-error"],palette:["--palette-base-100","--palette-base-800"],statusPalette:["--palette-green-500","--palette-yellow-500","--palette-red-500"]},vanilla:{semantic:["--color-primary","--color-primary-darker"],neutrals:["--color-surface","--color-surface-hover","--color-background"],palette:["--palette-vanilla-100","--palette-vanilla-200","--palette-vanilla-500","--palette-vanilla-800","--palette-vanilla-900"],accents:[]},blueberry:{semantic:["--color-primary","--color-primary-darker"],neutrals:["--color-surface","--color-surface-hover","--color-background"],palette:["--palette-blueberry-100","--palette-blueberry-200","--palette-blueberry-500","--palette-blueberry-800","--palette-blueberry-900"],accents:[]},strawberry:{semantic:["--color-primary","--color-primary-darker"],neutrals:["--color-surface","--color-surface-hover","--color-background"],palette:["--palette-strawberry-100","--palette-strawberry-200","--palette-strawberry-500","--palette-strawberry-800","--palette-strawberry-900"],accents:[]}};function F(e){if(!e||typeof e!="string")return null;const o=e.match(/^--palette-([^-]+)-(\d+)$/);if(o)return o[1].charAt(0).toUpperCase()+o[1].slice(1)+" "+o[2];const r=e.match(/^--palette-([^-]+)-([a-zA-Z]+)$/);return r?r[1].charAt(0).toUpperCase()+r[1].slice(1)+" "+r[2]:e.indexOf("--")===0?e.replace(/^--/,"").split("-").map(function(a){return a.charAt(0).toUpperCase()+a.slice(1)}).join(" "):e}function s(){document.querySelectorAll(".polaroid-card").forEach(function(e){var o=e.getAttribute("data-var");try{for(var r=e;r&&r!==document.documentElement&&!(r.classList&&Array.from(r.classList).some(function(t){return t.indexOf("flavor-")===0||t.indexOf("theme-")===0}));)r=r.parentElement;var a=o?c(o,void 0,r||document.documentElement):null}catch(t){console.error("Error resolving polaroid token:",o,t)}}),document.querySelectorAll("[data-var]").forEach(function(e){var o=e.getAttribute("data-var");if(o)try{for(var r=e;r&&r!==document.documentElement&&!(r.classList&&Array.from(r.classList).some(function(m){return m.indexOf("flavor-")===0||m.indexOf("theme-")===0}));)r=r.parentElement;var a=!1;r&&r.classList&&r.classList.contains("flavor-global")&&(a=!0);var t=null;if(a){var d={"--color-surface":"--palette-base-100","--color-surface-alt":"--palette-base-800","--color-success":"--palette-green-500","--color-warning":"--palette-yellow-500","--color-error":"--palette-red-500"};if(d[o]){var l=d[o];try{var n=c(l,void 0,document.documentElement);t={chain:[o,l],value:n&&n.value?n.value:getComputedStyle(document.documentElement).getPropertyValue(l).trim()||"unset"}}catch{t={chain:[o,l],value:getComputedStyle(document.documentElement).getPropertyValue(l).trim()||"unset"}}}else t=c(o,void 0,document.documentElement)}else t=c(o,void 0,r||document.documentElement);var p=t.value;if(e.classList.contains("list-resolved")&&(e.textContent=p||"unset"),e.classList.contains("list-chain")){var x=!1;try{var M=e.querySelector&&e.querySelector("code");M&&M.textContent&&M.textContent.indexOf("--palette-")===0&&(x=!0)}catch{}if(!x&&t&&t.value&&t.value!=="unset"){var A=null;try{if(t.chain&&Array.isArray(t.chain))for(var z=0;z<t.chain.length;z++){var $=t.chain[z];if($&&typeof $=="string"&&$.indexOf("--palette-")===0){A=F($);break}}}catch{}if(!A){var k=t.value,J={};try{Object.keys(P).forEach(function(m){var L=P[m];L&&Array.isArray(L.palette)&&L.palette.forEach(function(B){try{var j=getComputedStyle(document.documentElement).getPropertyValue(B).trim();if(j&&j!=="unset"){var ee=b(_(j)||j);ee&&(J[ee.toLowerCase()]=F(B))}}catch{}})}),["--palette-base-100","--palette-base-500","--palette-base-800","--palette-green-500","--palette-yellow-500","--palette-red-500","--palette-blueberry-300","--palette-vanilla-300","--palette-strawberry-300"].forEach(function(m){try{var L=getComputedStyle(document.documentElement).getPropertyValue(m).trim();if(L&&L!=="unset"){var B=b(_(L)||L);B&&(J[B.toLowerCase()]=F(m))}}catch{}});var X=b(_(k)||k);X&&(A=J[(X||"").toLowerCase()])}catch{}}if(A)e.innerHTML="<code>"+A+"</code>";else{try{window.__colors_last_resolutions=window.__colors_last_resolutions||[],window.__colors_last_resolutions.push({token:o,resolved:t&&t.value,chain:t&&t.chain,ctx:r&&r.className||null,ts:Date.now()})}catch{}var q="";try{t&&Array.isArray(t.chain)&&(q='<br/><small style="color:#aaa">'+t.chain.join(" → ")+"</small>"),t&&t.value&&(q+='<br/><small style="color:#aaa">'+t.value+"</small>")}catch{q=""}e.innerHTML='<small style="color:#888">Unknown base</small>'+q}}else e.innerHTML="–"}if(e.classList.contains("swatch-thumb")&&(p&&p!=="unset"?(e.style.background=p,e.style.backgroundColor=p):(e.style.background="transparent",e.style.backgroundColor="transparent")),e.classList.contains("list-text-color")&&p&&p!=="unset"){var f=null,C=null;if(o.includes("--palette-"))try{var E=v(p);if(E){var Z=T(E);f=Z>.5?"#000000":"#ffffff"}else f="#ffffff";C=b(f)}catch{f="#ffffff",C="#ffffff"}else{if(o.startsWith("--color-")){var te=o.replace(/^--color-/,""),Y="--color-on-"+te,K=c(Y,void 0,r||document.documentElement);K.value&&K.value!=="unset"&&(f=K.value,C=Y)}if(!f&&!o.includes("primary")){var Q=c("--color-on-background",void 0,r||document.documentElement);Q.value&&Q.value!=="unset"&&(f=Q.value,C="--color-on-background")}if(!f||f==="unset")try{var E=v(p);if(E){var Z=T(E);f=Z>.5?"#000000":"#ffffff",C=b(f)}else f="#ffffff",C="#ffffff"}catch{f="#ffffff",C="#ffffff"}}e.textContent=C||"unset";var N=e.parentElement.querySelector(".swatch-thumb-text");if(N&&f&&f!=="unset"){var re=b(f);N.style.color=re}var y=e.parentElement.querySelector(".list-contrast");if(y&&p&&f)try{var E=v(p),V=v(f);if(E&&V){var S=I(E,V);y.textContent=S.toFixed(1)+":1",S>=7?(y.style.color="#006600",y.style.fontWeight="bold"):S>=4.5?(y.style.color="#006600",y.style.fontWeight="normal"):S>=3?(y.style.color="#cc6600",y.style.fontWeight="normal"):(y.style.color="#cc0000",y.style.fontWeight="normal");var h=document.createElement("span");h.className="contrast-badge",h.textContent=S.toFixed(1)+":1",h.style.background="#FFFFFF",S>=7?(h.style.color="#006600",h.style.fontWeight="700"):S>=4.5?(h.style.color="#006600",h.style.fontWeight="600"):S>=3?(h.style.color="#cc6600",h.style.fontWeight="600"):(h.style.color="#a00000",h.style.fontWeight="600"),y.innerHTML="",y.appendChild(h)}}catch{y.textContent="–",y.style.color="",y.style.fontWeight=""}}}catch(m){console.error("Error processing element:",e,m),e.classList.contains("list-resolved")&&(e.textContent="error")}})}function g(){var e=document.querySelectorAll(".polaroid-card .swatch-text");e.forEach(function(o){try{var r=o.closest(".polaroid-card");if(!r)return;for(var a=r;a&&a!==document.documentElement&&!(a.classList&&Array.from(a.classList).some(function(k){return k.indexOf("flavor-")===0||k.indexOf("theme-")===0}));)a=a.parentElement;var t=r.getAttribute("data-var");if(!t)return;var d=c(t,void 0,a||document.documentElement),l=d.value;if(l&&l!=="unset"){var n=null;if(t.includes("--palette-"))try{var p=v(l);if(p){var x=T(p);n=x>.5?"#000000":"#ffffff"}else n="#ffffff"}catch{n="#ffffff"}else{var M=t.replace(/^--color-/,"").replace(/^palette-/,""),A="--color-on-"+M,z=c(A,void 0,a||document.documentElement);if(n=z.value,(!n||n==="unset")&&(t.includes("primary")&&(n=c("--color-on-primary",void 0,a||document.documentElement).value),(!n||n==="unset")&&(n=c("--color-on-background",void 0,a||document.documentElement).value)),!n||n==="unset")try{var p=v(l);if(p){var x=T(p);n=x>.5?"#000000":"#ffffff"}else n="#ffffff"}catch{n="#ffffff"}}try{var $=r.querySelector(".swatch-thumb-text");$&&(n&&n!=="unset"?$.style.color=b(n):$.style.color="")}catch{}}}catch{}})}function i(){s(),g()}return i}const ne={title:"0. Tokens/Colors",parameters:{viewMode:"docs"}},D={name:"Global",render:()=>R(),play:async()=>{const u=G();console.log("Colors story: executing color logic"),setTimeout(()=>{console.log("Colors story: first execution"),u()},100),setTimeout(()=>{console.log("Colors story: second execution"),u()},300),setTimeout(()=>{console.log("Colors story: third execution"),u()},600),setTimeout(()=>{try{if(window.__colors_observer){try{window.__colors_observer.disconnect()}catch{}window.__colors_observer=null}const c=new MutationObserver(v=>{v.forEach(w=>{if(w.attributeName==="class"||w.attributeName==="data-color-scheme"){console.log("Colors story: root attribute change detected, re-executing");try{u()}catch(_){console.error(_)}}})});c.observe(document.documentElement,{attributes:!0,attributeFilter:["class","data-color-scheme"]}),window.__colors_observer=c}catch{}},100),setTimeout(()=>{try{u()}catch(c){console.error(c)}},1200)}},W={name:"Theme: Blueberry",render:()=>R({onlyFlavor:"blueberry"}),play:async()=>{const u=G();setTimeout(u,100),setTimeout(u,300),setTimeout(u,600),setTimeout(u,1200),setTimeout(()=>{try{window.__colors_observer&&(window.__colors_observer.disconnect(),window.__colors_observer=null);const c=new MutationObserver(()=>{try{u()}catch{}});c.observe(document.documentElement,{attributes:!0,attributeFilter:["class","data-color-scheme"]}),window.__colors_observer=c}catch{}},120)}},U={name:"Theme: Strawberry",render:()=>R({onlyFlavor:"strawberry"}),play:async()=>{const u=G();setTimeout(u,100),setTimeout(u,300),setTimeout(u,600),setTimeout(u,1200)}},H={name:"Theme: Vanilla",render:()=>R({onlyFlavor:"vanilla"}),play:async()=>{const u=G();setTimeout(u,100),setTimeout(u,300),setTimeout(u,600)}};D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
  name: 'Global',
  render: () => renderColors(),
  play: async () => {
...
}`,...H.parameters?.docs?.source}}};const se=["Colors","Blueberry","Strawberry","Vanilla"];export{W as Blueberry,D as Colors,U as Strawberry,H as Vanilla,se as __namedExportsOrder,ne as default};
