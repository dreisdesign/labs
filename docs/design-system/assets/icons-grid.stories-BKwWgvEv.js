import{x as n}from"./iframe-DOjamwid.js";import"./preload-helper-D9Z9MdNV.js";const i=["add","add_circle","add_comment","apps","bedtime","bedtime_off","build","cancel","change_circle","check","check_box","check_box_outline_blank","check_indeterminate_small","close","code","colors","comment","content_copy","delete_forever","edit","history","indeterminate_check_box","open_in_new","published_with_changes","rate_review","settings","star","undo"],l={title:"Components/Icons",parameters:{layout:"fullscreen",docs:{description:{component:"Complete icon library for the Labs Design System. All icons are SVG-based with customizable size and color. Use the controls to test different sizes and colors across all available icons."}}},argTypes:{size:{control:{type:"range",min:16,max:64,step:1},description:"Icon size in pixels"},color:{control:"color",description:"Icon color"}}},o={render:(t={size:32,color:"#374151"})=>{const{size:e=32,color:a="#374151"}=t;return n`
      <style>
  ...
  .card { background: var(--color-surface); border: 1px solid #e5e7eb; border-radius: 8px; padding: 1rem; text-align: center; display: flex; flex-direction: column; align-items: center; gap: 0.5rem; min-height: 140px; justify-content: center; transition: all 0.2s ease; word-wrap: break-word; overflow-wrap: break-word; }
    ...
    `},args:{size:32,color:"var(--color-on-surface)"},parameters:{docs:{description:{story:"A clean grid layout showcasing all available icons in the Labs Design System."}}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  render: (args = {
    size: 32,
    color: '#374151'
  }) => {
...
}`,...o.parameters?.docs?.source}}};const d=["IconsGrid"];export{o as IconsGrid,d as __namedExportsOrder,l as default};
