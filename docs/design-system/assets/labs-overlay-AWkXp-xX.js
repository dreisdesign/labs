class r extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._isOpen=!1,this._render(),this._setupEventListeners()}_render(){this.shadowRoot.innerHTML=`
      <style>
        :host {
          position: fixed;
          top: 0;
