import{x as c}from"./iframe-DqYqYabm.js";import{i as l}from"./icons-list-Dfk_UYgx.js";import"./preload-helper-D9Z9MdNV.js";const t={"On Surface":"var(--color-on-surface)","On Primary":"var(--color-on-primary)",Primary:"var(--color-primary)",Error:"var(--color-error)","On Error":"var(--color-on-error)","Settings Icon":"var(--settings-icon-color)"},p={title:"Patterns/Buttons/Icon Only",argTypes:{icon:{options:l,control:{type:"select"},description:"Icon name"},colorVariant:{options:Object.keys(t),control:{type:"select"},description:"Icon color variant"},ariaLabel:{control:"text",description:"Aria label for accessibility"},animation:{control:"boolean",description:"Enable icon hover animation"}},parameters:{docs:{description:{component:"A canonical pattern for icon-only actions. Used for theme, delete, settings, close, etc. Supports animation and accessibility."}}}},o=({icon:r="settings",colorVariant:a="On Surface",ariaLabel:e="Settings",animation:i=!0})=>{const s=`
