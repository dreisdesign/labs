      ...
      t = (c) =>
        c
          ? c
              ...
              .replace(/-/g, "_")
          : "",
      s = t(this.getAttribute("icon"));
    let n = t(this.getAttribute("icon-right"));
    !n && this.hasAttribute("default-icon-right") && (n = "settings");
    const b =
        this.getAttribute("checkmark-icon") || "icons/check--labs-icons.svg",
      l = this.getAttribute("label") || "",
      i = this.hasAttribute("checkmark"),
      a = this.getAttribute("variant") || "primary";
...
const d = {
  ...
  m = ({
    ...
    let i = e ? t || "undo" : "",
      a = s ? n || "settings--labs-icons" : "",
      c = "#fff";
    return (
      l === "danger" && ((i = "delete_forever"), (a = ""), (c = "#b5005a")),
      `
    <labs-button
      label="${u || ""}"
      ${i ? `icon="${i}"` : ""}
...
`;
r.storyName = "Preview All Buttons";
o.parameters = {
  ...o.parameters,
  docs: {
    ...o.parameters?.docs,
...
const g = ["Default", "IconGrid"];
export { o as Default, r as IconGrid, g as __namedExportsOrder, d as default };
