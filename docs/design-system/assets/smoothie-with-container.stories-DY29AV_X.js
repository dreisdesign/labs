import"./labs-footer-Cz6M6BBG.js";import"./iframe-CzJGwEif.js";import{i as m}from"./icons-list-BKmguoAm.js";import"./labs-overlay-AWkXp-xX.js";import"./labs-settings-card-BjNpaBW8.js";import"./labs-input-card-CKscVP7Z.js";import"./labs-card-BAnoYprD.js";import"./labs-list-item-K4yq-fbA.js";import"./labs-checkbox-CW6xedIE.js";import"./labs-dropdown-vlOVR_pw.js";import"./preload-helper-PPVm8Dsz.js";const p=document.createElement("template");p.innerHTML=`
  <style>
  ...
  <slot></slot>
`;class b extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(p.content.cloneNode(!0))}connectedCallback(){this.hasAttribute("role")||this.setAttribute("role","region")}}customElements.get("labs-container")||customElements.define("labs-container",b);const M={title:"Templates/Smoothie",parameters:{docs:{description:{component:"Smoothie template that includes the canonical content container (`labs-container`). Use the `layout` arg to pick `list` or `full` behaviors."}}},argTypes:{settingsIcon:{control:{type:"select"},options:Object.keys(m)},layout:{control:{type:"radio"},options:["narrow","wide","edge"],description:"Choose `narrow` (app-like constrained), `wide` (full width with paddings), or `edge` (edge-to-edge full bleed)."},maxWidth:{control:{type:"text"},description:"Override `--app-container-max` (e.g. 720px)"}}},a={name:"Default",render:t=>{const e=document.createElement("div"),i=t.maxWidth?`--app-container-max: ${t.maxWidth};`:"",l=t.layout==="edge"?"fullbleed":"",s=t.layout==="wide"&&!t.maxWidth?"--app-container-max: 960px;":"",r=[i,s].filter(Boolean).join(" ");e.innerHTML=`
      <style>
...
}`,...n.parameters?.docs?.source}}};const T=["Default","WithFooter"];export{a as Default,n as WithFooter,T as __namedExportsOrder,M as default};
