import"./iframe-DOjamwid.js";import"./preload-helper-D9Z9MdNV.js";const e={title:"Tokens/Typography",parameters:{viewMode:"docs"}},t={name:"Typography",render:()=>`
        ...
        <table style="border-collapse:collapse; width:100%; font-size:0.98em; background:var(--color-surface-variant, var(--color-surface, #f8f8f8));">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>400</td>
              <td>1.5</td>
              <td><span style="font-size:var(--font-size-entry-text);">Entry text</span></td>
            </tr>
            <tr>
              ...
              <td>400</td>
              <td>1.3</td>
              <td><span style="font-size:var(--font-size-entry-meta);">Entry meta</span></td>
            </tr>
            <tr>
              ...
              <td>600</td>
              <td>1.2</td>
              <td><span style="font-size:var(--font-size-button); font-weight:var(--font-weight-button); line-height:var(--line-height-button);">Button text</span></td>
            </tr>
            <tr>
              ...
              <td>600</td>
              <td>1.2</td>
              <td><span style="font-size:var(--font-size-card-header); font-weight:var(--font-weight-card-header); line-height:var(--line-height-card-header);">Card header</span></td>
            </tr>
            <tr>
              ...
              <td>400</td>
              <td>1.4</td>
              <td><span style="font-size:var(--font-size-card-desc); line-height:var(--line-height-card-desc);">Card description</span></td>
            </tr>
            <tr>
              ...
              <td>400</td>
              <td>1.3</td>
              <td><span style="font-size:var(--font-size-toast); line-height:var(--line-height-toast);">Toast message</span></td>
            </tr>
            <tr>
              ...
              <td>500</td>
              <td>1.2</td>
              <td><span style="font-size:var(--font-size-badge); font-weight:var(--font-weight-badge); line-height:var(--line-height-badge);">Badge text</span></td>
            </tr>
            <tr>
              ...
              <td>400</td>
              <td>1.4</td>
              <td><span style="font-size:var(--font-size-input); line-height:var(--line-height-input);">Input text</span></td>
            </tr>
            <tr>
              ...
              <td>400</td>
              <td>1.4</td>
              <td><span style="font-size:var(--font-size-footer); line-height:var(--line-height-footer);">Footer text</span></td>
            </tr>
            <tr>
              ...
              <td>400</td>
              <td>1.5</td>
              <td><span style="font-size:var(--font-size-overlay); line-height:var(--line-height-overlay);">Overlay text</span></td>
            </tr>
          </tbody>
        </table>
      </div>
  ...
  \`
}`,...t.parameters?.docs?.source}}};const d=["Typography"];export{t as Typography,d as __namedExportsOrder,e as default};
