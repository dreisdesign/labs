import"./labs-card-C_PRdaQ6.js";import"./iframe-CiIWiEO2.js";import"./preload-helper-PPVm8Dsz.js";const i={title:"3. Components (Wrapped)/Card/Welcome",component:"labs-card",parameters:{docs:{description:{component:"A wrapped welcome card variant using the canonical labs-card. Shows header, description, actions, and (optionally) an icon."}}}},n=()=>{const t=document.createElement("labs-card");t.style.maxWidth="420px";const a=document.createElement("span");a.slot="header",a.textContent="Welcome!",t.appendChild(a);const o=document.createElement("span");o.slot="description",o.textContent="Get started by exploring our design system components.",t.appendChild(o);const e=document.createElement("div");e.slot="actions",e.style.display="flex",e.style.gap="10px",e.style.justifyContent="center";const c=document.createElement("labs-button");return c.setAttribute("variant","primary"),c.textContent="Get Started",e.appendChild(c),t.appendChild(e),t};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`() => {
