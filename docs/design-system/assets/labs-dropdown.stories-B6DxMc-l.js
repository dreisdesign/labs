import"./labs-list-item-DRXnSJON.js";class l extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._open=!1,this.render()}static get observedAttributes(){return["archived","restored"]}attributeChangedCallback(){this.render()}connectedCallback(){document.addEventListener("click",this._outsideClick=e=>{this._open&&!this.contains(e.target)&&!this.shadowRoot.contains(e.target)&&this._close()})}disconnectedCallback(){document.removeEventListener("click",this._outsideClick)}render(){this.shadowRoot.innerHTML=`
      <style>
