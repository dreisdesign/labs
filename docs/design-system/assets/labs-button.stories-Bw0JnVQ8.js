import { ThemeToggleButton as d } from "./theme-toggle.stories-zb0FDYs4.js";
...
const f = {
  ...
  p = ({
    ...
    let r = i ? l || "undo" : "",
      ...
      c = "#fff";
    return (
      a === "danger" && ((r = "delete_forever"), (t = ""), (c = "#b5005a")),
      `
    <labs-button
      label="${o || ""}"
      ${r ? `icon="${r}"` : ""}
...
e.parameters = { controls: { disable: !0 } };
e.storyName = "Preview All Buttons";
n.parameters = {
  ...n.parameters,
  docs: {
    ...n.parameters?.docs,
...
const y = ["Default", "IconGrid"];
export { n as Default, e as IconGrid, y as __namedExportsOrder, f as default };
