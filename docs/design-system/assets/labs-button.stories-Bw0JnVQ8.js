import{ThemeToggleButton as d}from"./theme-toggle.stories-zb0FDYs4.js";import"./labs-icon-Du3np7tU.js";const f={title:"Components/Button",argTypes:{label:{control:"text"},iconLeft:{control:"boolean",name:"Icon Left"},icon:{control:{type:"select"},name:"Left Icon Name",description:"Set left icon name (if iconLeft is true)",options:["","add_comment","bedtime","bedtime_off","cancel","change_circle","check","close","comment","delete_forever","edit","rate_review","settings","undo"]},iconRight:{control:"boolean",name:"Icon Right"},iconRightName:{control:{type:"select"},name:"Right Icon Name",description:"Set right icon name (if iconRight is true)",options:["","add_comment","bedtime","bedtime_off","cancel","change_circle","check","close","comment","delete_forever","edit","rate_review","settings","undo"]},checkmark:{control:"boolean",name:"Check Animation"},variant:{control:{type:"select"},options:["primary","secondary","danger","success"]}}},p=({label:o,iconLeft:i,icon:l,iconRight:s,iconRightName:b,checkmark:m,variant:a})=>{let r=i?l||"undo":"",t=s?b||"settings--labs-icons":"",c="#fff";return a==="danger"&&(r="delete_forever",t="",c="#b5005a"),`
    <labs-button
      label="${o||""}"
      ${r?`icon="${r}"`:""}
      ${t?`icon-right="${t}"`:""}
      ...
      iconcolor="${c}"
    ></labs-button>
  `},n=p.bind({});n.args={label:"Primary Button",iconLeft:!1,icon:"",iconRight:!1,iconRightName:"",checkmark:!1,variant:"primary"};n.storyName="Primary";const e=()=>{const o=document.createElement("div");return o.style.display="flex",o.style.gap="1rem",o.style.flexWrap="wrap",o.style.alignItems="flex-end",o.innerHTML=`
  ...
  `,o.appendChild(d()),o};e.parameters={controls:{disable:!0}};e.storyName="Preview All Buttons";n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`({
  label,
  iconLeft,
  icon,
  iconRight,
