import"./labs-footer-BN2MhWoz.js";import"./labs-settings-overlay-3r6b2jXA.js";import"./labs-button-DO-8kIze.js";import"./labs-icon-CWhhJZRA.js";import"./labs-theme-toggle-button-D75b0QSc.js";import"./button-configs-UvNeOF8F.js";class s extends HTMLElement{constructor(){super(),this._listenersSetup=!1}static get observedAttributes(){return["add-label","variant"]}attributeChangedCallback(){this.render()}connectedCallback(){this.render(),this.setupEventListeners()}setupEventListeners(){this._listenersSetup||setTimeout(()=>{const t=this.querySelector("labs-footer"),e=this.querySelector("labs-settings-overlay");t&&e?(t.addEventListener("settings-click",()=>e.open()),this._listenersSetup=!0):console.warn("labs-app-footer: Child components not found",{footer:t,overlay:e})},0)}render(){const t=this.getAttribute("add-label")||"+ Add",e=this.getAttribute("variant")||"default";this.innerHTML=`
      <!-- Footer Component -->
      <labs-footer 
        add-label="${t}" 
        ${e!=="default"?`variant="${e}"`:""}
    ...
    `,this._listenersSetup||this.setupEventListeners()}}customElements.define("labs-app-footer",s);const u={title:"Patterns/Footer with Settings",component:"labs-app-footer",parameters:{docs:{description:{component:`
...
- **Performance Critical**: Use separate components for fine-grained control
  ...
  return container;
}`,...r.parameters?.docs?.source}}};const h=["DefaultFooter","FloatingFooter"];export{a as DefaultFooter,r as FloatingFooter,h as __namedExportsOrder,u as default};
