import"./labs-checkbox-CW6xedIE.js";import"./labs-list-item-161w7GBt.js";import"./iframe-BEVxoZ3v.js";import"./labs-toast-Dmd2L4o2.js";import"./preload-helper-D9Z9MdNV.js";const I={title:"Components/List Item/Archived",component:"labs-list-item"},o=()=>{const e=document.createElement("div");e.style.display="flex",e.style.flexDirection="column",e.style.gap="12px",e.style.width="100%",e.style.maxWidth="600px",e.style.margin="0 auto";const r=document.createElement("labs-toast");e.appendChild(r);function m(t){t.addEventListener("remove",()=>{r.show("Item removed",{actionText:"Undo",duration:4e3}),r.addEventListener("action",()=>{e.contains(t)||e.insertBefore(t,r.nextSibling)},{once:!0})})}function a({id:t,value:n,archived:p=!1,restored:h=!1,originalId:l=null}){const i=document.createElement("labs-list-item");return t&&i.setAttribute("data-id",t),n&&i.setAttribute("value",n),p&&i.setAttribute("archived",""),h&&i.setAttribute("restored",""),l&&i.setAttribute("data-original-id",l),m(i),i}function d(t){const n=document.createElement("div");n.style.fontWeight="600",n.style.marginTop="18px",n.textContent=t,e.appendChild(n)}const c=new Date,s=new Date(Date.now()-1440*60*1e3);return c.toISOString().slice(0,10),s.toISOString().slice(0,10),d("Today — "+new Date().toLocaleDateString()),e.appendChild(a({id:"1-T",value:"Default Item",archived:!1,timestamp:new Date().toISOString()})),d("Archived items"),e.appendChild(a({id:"1-A",value:"Archived Item",archived:!0,timestamp:s.toISOString()})),d("3) Restored pair (Archived original + Restored copy)"),e.appendChild(a({id:"2-A",value:"Archived (Restored)",archived:!0,restored:!0,timestamp:s.toISOString()})),e.appendChild(a({id:"2-T",value:"Restored Item",originalId:"2-A",timestamp:new Date().toISOString()})),d("4) Restored (original deleted)"),e.appendChild(a({id:"3-T",value:"Restored Item (orig deleted)",originalId:"3-A",timestamp:new Date().toISOString()})),e};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`() => {
  ...
  return wrapper;
}`,...o.parameters?.docs?.source}}};const f=["States"];export{o as States,f as __namedExportsOrder,I as default};
