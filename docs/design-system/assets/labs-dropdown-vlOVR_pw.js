class c extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._open=!1,this._menuId=`labs-dropdown-menu-${Math.random().toString(36).slice(2,8)}`,this.render()}static get observedAttributes(){return["archived","restored","open","only"]}attributeChangedCallback(t){t==="open"&&(this._open=this.hasAttribute("open")),this.render()}get open(){return this._open}set open(t){!!t?this.setAttribute("open",""):this.removeAttribute("open")}connectedCallback(){document.addEventListener("click",this._outsideClick=t=>{if(!this._open)return;const e=t.composedPath?t.composedPath():t.path||[];!e.includes(this)&&!e.includes(this.shadowRoot)&&(!this._portaledMenu||!e.includes(this._portaledMenu))&&this._close()})}disconnectedCallback(){document.removeEventListener("click",this._outsideClick),this._cleanupPortaledMenu()}render(){this.shadowRoot.innerHTML=`
    ...
    `,this._createPortaledMenu();const t=this.shadowRoot.getElementById("toggleBtn");t&&(t.addEventListener("click",i=>{i.stopPropagation(),this._toggle()}),t.addEventListener("keydown",i=>this._onToggleKeyDown(i))),this._open?(this._portaledMenu&&(this._portaledMenu.style.display="block",this._portaledMenu.setAttribute("aria-hidden","false"),this._positionPortaledMenu()),this.dispatchEvent(new CustomEvent("open",{bubbles:!0,composed:!0}))):(this._portaledMenu&&(this._portaledMenu.style.display="none",this._portaledMenu.setAttribute("aria-hidden","true")),this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0})));const e=this.shadowRoot.getElementById("toggleBtn");e&&e.setAttribute("aria-expanded",String(this._open))}_getMenuItems(){const t=this._portaledMenu||document.getElementById(this._menuId);return t?Array.from(t.querySelectorAll("labs-button")):[]}_focusItemAt(t){const e=this._getMenuItems();if(!e.length)return;const i=(t+e.length)%e.length,o=e[i];if(o){o.hasAttribute("tabindex")||o.setAttribute("tabindex","0");try{o.focus()}catch{}this._currentIndex=i}}_focusFirstItem(){this._focusItemAt(0)}_focusLastItem(){const t=this._getMenuItems();this._focusItemAt(t.length-1)}_onToggleKeyDown(t){const e=t.key;e==="Enter"||e===" "||e==="Spacebar"?(t.preventDefault(),t.stopPropagation(),this.open=!0,this._focusFirstItem()):e==="ArrowDown"?(t.preventDefault(),t.stopPropagation(),this.open=!0,this._focusFirstItem()):e==="ArrowUp"&&(t.preventDefault(),t.stopPropagation(),this.open=!0,this._focusLastItem())}_onMenuKeyDown(t){const e=t.key;if(this._getMenuItems().length)if(e==="ArrowDown")t.preventDefault(),t.stopPropagation(),this._focusItemAt((this._currentIndex||0)+1);else if(e==="ArrowUp")t.preventDefault(),t.stopPropagation(),this._focusItemAt((this._currentIndex||0)-1);else if(e==="Home")t.preventDefault(),t.stopPropagation(),this._focusFirstItem();else if(e==="End")t.preventDefault(),t.stopPropagation(),this._focusLastItem();else if(e==="Escape"){t.preventDefault(),t.stopPropagation(),this._close();const o=this.shadowRoot.getElementById("toggleBtn");o&&o.focus()}else e==="Tab"&&this._close()}_toggle(){this.open=!this._open}_close(){this.open=!1}_createPortaledMenu(){let t=document.getElementById("labs-dropdown-portal");t||(t=document.createElement("div"),t.id="labs-dropdown-portal",t.style.cssText=`
                position: fixed;
                top: 0;
                left: 0;
                pointer-events: none;
