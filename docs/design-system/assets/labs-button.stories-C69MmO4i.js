import"./labs-button-CTm3BRv_.js";import"./labs-icon-8279HnLw.js";const g={title:"Components/Button",argTypes:{label:{control:"text"},iconLeft:{control:"boolean",name:"Icon Left"},icon:{control:{type:"select"},name:"Left Icon Name",description:"Set left icon name (if iconLeft is true)",options:["","add_comment","bedtime","bedtime_off","cancel","change_circle","check","close","comment","delete_forever","edit","rate_review","settings","undo"]},iconRight:{control:"boolean",name:"Icon Right"},iconRightName:{control:{type:"select"},name:"Right Icon Name",description:"Set right icon name (if iconRight is true)",options:["","add_comment","bedtime","bedtime_off","cancel","change_circle","check","close","comment","delete_forever","edit","rate_review","settings","undo"]},checkmark:{control:"boolean",name:"Check Animation"},variant:{control:{type:"select"},options:["primary","secondary","danger","success"]}}},m=({label:r,iconLeft:i,icon:l,iconRight:s,iconRightName:b,checkmark:f,variant:a})=>{let e=i?l||"undo":"",t=s?b||"settings--labs-icons":"",c="#fff";return a==="danger"&&(e="delete_forever",t="",c="#b5005a"),`
    <labs-button
      label="${r||""}"
      ${e?`icon="${e}"`:""}
      ${t?`icon-right="${t}"`:""}
      ...
      iconcolor="${c}"
    ></labs-button>
  `},n=m.bind({});n.args={label:"Primary Button",iconLeft:!1,icon:"",iconRight:!1,iconRightName:"",checkmark:!1,variant:"primary"};n.storyName="Primary";const o=()=>`
...
`;o.storyName="Preview All Buttons";n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`({
  label,
  iconLeft,
  icon,
  iconRight,
...
\``,...o.parameters?.docs?.source}}};const p=["Default","IconGrid"];export{n as Default,o as IconGrid,p as __namedExportsOrder,g as default};
