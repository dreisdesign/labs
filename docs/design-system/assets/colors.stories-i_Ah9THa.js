import "./iframe-DzJGxyCr.js"; import "./preload-helper-D9Z9MdNV.js"; function D(i = {}) {
  const l = i && i.onlyFlavor ? String(i.onlyFlavor) : "", f = { global: { "--palette-base-100": "Surface", "--palette-base-500": "Outline", "--palette-base-800": "Text", "--palette-green-500": "Success", "--palette-yellow-500": "Warning", "--palette-red-500": "Error" }, vanilla: { "--palette-vanilla-100": "Background", "--palette-vanilla-500": "Primary", "--palette-vanilla-800": "Primary Darker" }, blueberry: { "--palette-blueberry-200": "Background", "--palette-blueberry-500": "Primary", "--palette-blueberry-800": "Primary Darker" }, strawberry: { "--palette-strawberry-200": "Background", "--palette-strawberry-500": "Primary", "--palette-strawberry-800": "Primary Darker" } }, x = (a, u, e, o) => {
    let r = ""; return f[a] && f[a][e] && (r = `<br><span style="font-weight:bold;font-size:13px;opacity:0.8;">${f[a][e]}</span>`), `
...
}; const K = ["Colors", "Blueberry", "Strawberry", "Vanilla"]; export { O as Blueberry, B as Colors, z as Strawberry, M as Vanilla, K as __namedExportsOrder, Y as default };
