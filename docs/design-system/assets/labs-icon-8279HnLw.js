...
class a extends HTMLElement {
  ...
  render() {
    ...
    let t = l[s];
    if (t) {
      const i = window.getComputedStyle(this),
        n = this.getAttribute("width") || i.width || "24px",
        c = this.getAttribute("height") || i.height || "24px";
      this.innerHTML = `<img src="${t}" width="${parseInt(n)}" height="${parseInt(c)}" style="display:inline-block;vertical-align:middle;" alt="${s}" />`;
    } else this.innerHTML = "";
  }
}
customElements.define("labs-icon", a);
