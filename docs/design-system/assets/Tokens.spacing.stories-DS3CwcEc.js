    ...
    return (
      ...
      o.forEach((s) => {
        ...
        (e.style.height = `var(--${s})`),
          ...
          (e.innerHTML = `<strong>--${s}</strong> <span style="margin-left:0.5rem; color:#666;">${getComputedStyle(document.documentElement).getPropertyValue(`--${s}`)}</span>`),
          t.appendChild(e);
      }),
      t
    );
...
const c = ["Spacing"];
export { n as Spacing, c as __namedExportsOrder, r as default };
