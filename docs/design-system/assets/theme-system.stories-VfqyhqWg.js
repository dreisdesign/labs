const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./iframe-Cc9enzfm.js","./preload-helper-D9Z9MdNV.js","./iframe-8nzp3Krn.css"])))=>i.map(i=>d[i]);
import{_ as d}from"./preload-helper-D9Z9MdNV.js";import"./iframe-Cc9enzfm.js";import{c as u}from"./ThemeToggle-DPg-in-y.js";const b={title:"Foundation/Theme System",parameters:{viewMode:"docs",docs:{description:{component:`
...
Use the theme toggle button below or the Storybook toolbar to test the theme system. All components should smoothly transition between light and dark modes.
    ...
    `,setTimeout(()=>{u({parent:e});const t=e.querySelector("#iconThemeToggle"),a=e.querySelector("#iconThemeIcon");function c(){const n=document.documentElement.classList.contains("theme-dark");a&&a.setAttribute("name",n?"bedtime_off":"bedtime"),t&&t.setAttribute("aria-label",n?"Switch to light mode":"Switch to dark mode")}t&&(t.addEventListener("click",()=>{const n=document.documentElement.classList.contains("theme-dark"),s=document.documentElement,l=Array.from(s.classList).find(o=>o.startsWith("flavor-")),i=l?l.replace("flavor-",""):"vanilla";d(async()=>{const{applyTheme:o}=await import("./iframe-Cc9enzfm.js").then(m=>m.t);return{applyTheme:o}},__vite__mapDeps([0,1,2]),import.meta.url).then(({applyTheme:o})=>{o({flavor:i,theme:n?"light":"dark"}),c()})}),c())},100),e},parameters:{docs:{source:{code:`
