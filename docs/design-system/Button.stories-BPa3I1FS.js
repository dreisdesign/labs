class r extends HTMLElement{constructor(){super();const e=this.attachShadow({mode:"open"}),s=window.location.pathname.includes("/labs/")?"/labs":"";e.innerHTML=`
      <style>
        @import url('${s}/design-system/main.css');
        button {
    ...
    `,this._btn=e.querySelector("button")}connectedCallback(){this.hasAttribute("disabled")&&(this._btn.disabled=!0)}static get observedAttributes(){return["disabled"]}attributeChangedCallback(e,s,l){e==="disabled"&&(this._btn.disabled=this.hasAttribute("disabled"))}}customElements.define("labs-button",r);const{fn:a}=__STORYBOOK_MODULE_TEST__,c={title:"Components/Button",tags:["autodocs"],render:t=>Button(t),argTypes:{backgroundColor:{control:"color"},size:{control:{type:"select"},options:["small","medium","large"]}},args:{onClick:a()},parameters:{docs:{description:{component:"Labs Design System Button Web Component."}}}},o=()=>{const t=document.createElement("labs-button");return t.textContent="Primary Button",t},n=()=>{const t=document.createElement("labs-button");return t.textContent="Disabled Button",t.setAttribute("disabled",""),t};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`() => {
